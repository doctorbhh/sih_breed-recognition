  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cattle: "gradient-cattle text-white hover:shadow-glow transition-smooth font-semibold",
        wheat: "gradient-wheat text-foreground hover:shadow-medium transition-smooth font-semibold",
        barn: "gradient-barn text-white hover:shadow-medium transition-smooth font-semibold",
        upload: "border-2 border-dashed border-border bg-muted/30 text-muted-foreground hover:border-primary hover:bg-primary/5 hover:text-primary transition-smooth py-6",
      },
      size: {
